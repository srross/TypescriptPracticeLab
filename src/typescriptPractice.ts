...
function getTallestMountain(mountainArray:Array<Mountain>) : string{
...
function calcAverageProductPrice(productArray:Array<Product>) : number{
    ...
    let i = 0;
    let sum:number = 0;
    let itemCount:number = productArray.length;
    let aveProductPrice:number = 0;
...
function calcInventoryValue(productArray:Array<InventoryItem>) : number{
